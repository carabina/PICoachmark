...
// PICoachmark
#define COCOAPODS_POD_AVAILABLE_PICoachmark
#define COCOAPODS_VERSION_MAJOR_PICoachmark 0
#define COCOAPODS_VERSION_MINOR_PICoachmark 0
#define COCOAPODS_VERSION_PATCH_PICoachmark 1
